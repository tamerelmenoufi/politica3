...
$query = "SELECT count(*) as qt FROM servicos s "
    ...
    . "WHERE s.tipo = '2' AND s.deletado = '0' {$where}";
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb shadow bg-gray-custom">
        ...
        <li class="breadcrumb-item active" aria-current="page">RG (Foram encontrados <?=$total?> registros, exibidos em páginas de <?=$limite?>)</li>
    </ol>
</nav>
