...
if($_SESSION['campo_busca']){
    ...
    $where  = " and (
                            s.especialista like '%{$_SESSION['campo_busca']}%'
                        or  a.nome like '%{$_SESSION['campo_busca']}%'
...
$query = "SELECT count(*) as qt FROM servicos s "
    ...
    . "WHERE s.tipo = '7' AND s.deletado = '0' AND s.categoria = '{$categoria}' {$where}";
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb shadow bg-gray-custom">
        ...
        <li class="breadcrumb-item active" aria-current="page">Saúde (Foram encontrados <?=$total?> registros, exibidos em páginas de <?=$limite?>)</li>
    </ol>
</nav>
