...
$query = "SELECT count(*) as qt FROM servicos s "
    ...
    . "WHERE s.tipo = '5' AND s.deletado = '0' {$where}";
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb shadow bg-gray-custom">
        ...
        <li class="breadcrumb-item active" aria-current="page">Psicologia (Foram encontrados <?=$total?> registros, exibidos em páginas de <?=$limite?>)</li>
    </ol>
</nav>
<!-- PAGINACAO -->
<div class="row">
